...
import com.ruibranco.cursomc.dto.ClienteDto;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possivel excluir um Cliente porque existe relacionamentos");
		}
	}
	...
	public Cliente fromDTO(ClienteNewDto objDto) {
		...
		Endereco end = new Endereco(null, objDto.getLogradouro(), objDto.getNumero(),
				objDto.getCompleto(), objDto.getBairro(), objDto.getCep(), cli, cid); 
